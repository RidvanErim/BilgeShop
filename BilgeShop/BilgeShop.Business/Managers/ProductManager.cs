...
namespace BilgeShop.Business.Managers
{
    public class ProductManager : IProductService
    {
        ...
        public ProductDetailDto GetProductDetailDto(int id)
        {

            var productDetailDtoEntity = _productRepository.GetById(id);
            var prodductDetailDto = new ProductDetailDto()
            {
                Name = productDetailDtoEntity.Name,
                Id = productDetailDtoEntity.Id,
                Description = productDetailDtoEntity.Description,
                ImagePath = productDetailDtoEntity.ImagePath,
            };
            return prodductDetailDto;
        }
